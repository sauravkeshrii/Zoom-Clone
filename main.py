...
#AudioSender, AudioReceiver, ScreenShareClient, CameraClient, StreamingServer
import socket
...
def start_audio_stream():
    ...
    t5 = threading.Thread(audio_sender.start_stream)
    t5.start()

    
print(local_ip_address)
# local ip adress helps when the devices are connected to same local network
# par agar internet ka use kr rhe hai, to hame public_ip_adress ki jarurat paregi !
